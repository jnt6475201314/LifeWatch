...
#import "HealthDataMonthViewController.h"

@interface HealthyDataViewController ()<UIScrollViewDelegate, selectedBtnDelegate>
...
@implementation HealthyDataViewController
...
-(void)setupChildVces
{
    HealthDataDailyViewController *dailyVC = [[HealthDataDailyViewController alloc]init];
    dailyVC.userID = self.userID;
    dailyVC.relation = self.relation;
    [self addChildViewController:dailyVC];
    
    HealthDataMonthViewController *monthVC = [[HealthDataMonthViewController alloc]init];
    monthVC.userID = self.userID;
    monthVC.relation = self.relation;
