//
//  HealthDataMonthViewController.m
//  LifeWatch
//
...
@interface HealthDataMonthViewController ()<UITableViewDelegate, UITableViewDataSource, ReportMonthPickerDelegate>
{
...
@implementation HealthDataMonthViewController
...
- (void)loadDataWithMonth:(NSString *)month{
    ...
    NSDictionary * params = @{@"method":@"all", @"user_id":self.userID!=nil?self.userID:KGetUserID, @"type":@"2", @"time":month};
