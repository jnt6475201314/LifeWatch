...
@interface HealthyReportViewController ()<UIScrollViewDelegate, selectedBtnDelegate>
...
@implementation HealthyReportViewController
...
- (void)configUI{
    ...
    self.selectTitleArray = @[Report_Monthlly, Report_Annually];
...
-(void)setupChildVces
{
    HealthMonthlyViewController *monthVC = [[HealthMonthlyViewController alloc]init];
    monthVC.userID = self.userID;
    [self addChildViewController:monthVC];
    
    HealthAnnuallyViewController *annuaVC = [[HealthAnnuallyViewController alloc]init];
    annuaVC.userID = self.userID;
    [self addChildViewController:annuaVC];
