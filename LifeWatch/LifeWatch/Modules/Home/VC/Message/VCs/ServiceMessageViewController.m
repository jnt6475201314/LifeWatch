...
{
    NSDictionary * params = @{@"method":@"SetMessageReaded",@"user_id":KGetUserID,  @"data_type":@"3"};
...
- (void)loadData{
    ...
    NSDictionary * params = @{@"method":@"GetMemberMessage",@"user_id":KGetUserID,  @"category":@"3", @"page_size":@"10", @"page_index":@"1"};
...
- (void)loadMoreData
{
    ...
    NSDictionary * params = @{@"method":@"GetMemberMessage",@"user_id":KGetUserID,  @"category":@"3", @"page_size":@"10", @"page_index":@(self.page_index)};
    [NetRequest postUrl:url Parameters:params success:^(NSDictionary *resDict) {
        NSLog(@"%@", resDict);
