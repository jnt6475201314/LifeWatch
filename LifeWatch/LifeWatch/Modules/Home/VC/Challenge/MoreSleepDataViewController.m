...
@interface MoreSleepDataViewController ()<UITableViewDelegate, UITableViewDataSource, ReportMonthPickerDelegate>
{
    NSString * query_date;
    NSDate * date;
...
@implementation  MoreSleepDataViewController
...
- (void)loadDataWithMonth:(NSString *)month{
    ...
    NSDictionary * params = @{@"method":@"GetHealthData", @"data_type":@"sleep", @"user_id":KGetUserID, @"date_type":@"2", @"date":month};
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    _stepLab.text = Goal_Actual_hours;
