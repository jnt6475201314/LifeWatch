//
//  ReceivedRescueViewController.m
//  LifeWatch
//
...
@interface ReceivedRescueViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation ReceivedRescueViewController
...
- (void)loadData{
    ...
    NSDictionary * params = @{@"method":@"MyReceiveSOSList",@"user_id":KGetUserID, @"sos_id":@"1", @"data_type":@"0", @"page_size":@"10", @"page_index":@"1"};
...
- (void)loadMoreData
{
    self.page_index++;
    NSString * url = KMyReceiveSOSListUrl;
    NSDictionary * params = @{@"method":@"MyReceiveSOSList",@"user_id":KGetUserID, @"sos_id":@"1", @"data_type":@"0", @"page_size":@"10", @"page_index":@(self.page_index)};
    [NetRequest postUrl:url Parameters:params success:^(NSDictionary *resDict) {
        NSLog(@"%@", resDict);
